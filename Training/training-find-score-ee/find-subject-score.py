...
template_path = Path("EE2-input-score.xlsx")
st.markdown("### 📥 Tải mẫu file nhập điểm có sẵn")
if template_path.exists():
    with open(template_path, "rb") as f:
        st.download_button(
            label="Tải xuống EE2-input-score.xlsx",
            data=f.read(),
            file_name="EE2-input-score.xlsx",
...
GGM_PATH   = Path("models_streamlit/EE2_ggm.joblib")
